        ...
        >
          ...
          >
            <div>
              ...
              >
                Register to access your banking dashboard, open accounts, and manage balances in one secure place.
              </p>
            </div>
            ...
            >
              <InfoCard
                title="Quick setup"
                description="Create your profile with your name, email, and password to get started right away."
              />
              <InfoCard
                title="Banking access"
                description="Once registered, you’ll be signed in automatically and taken directly to your dashboard."
              />
            </div>
          </div>
          ...
          >
            ...
            >
              <div style={{ marginBottom: '1.35rem' }}>
                ...
                >
                  Enter your details below to create a new banking account.
                </p>
              </div>
